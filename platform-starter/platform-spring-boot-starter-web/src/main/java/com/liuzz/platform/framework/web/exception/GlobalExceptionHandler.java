package com.liuzz.platform.framework.web.exception;
...
import static com.liuzz.platform.common.domain.GlobalCode.*;
...
public class GlobalExceptionHandler {
    ...
    public R<?> missingServletRequestParameterExceptionHandler(MissingServletRequestParameterException ex) {
        ...
        return R.error(String.format("请求参数缺失:%s", ex.getParameterName()), BAD_REQUEST.getCode());
    }
    ...
    public R<?> methodArgumentTypeMismatchExceptionHandler(MethodArgumentTypeMismatchException ex) {
        log.warn("[missingServletRequestParameterExceptionHandler]", ex);
        return R.error(String.format("请求参数类型错误:%s", ex.getMessage()), BAD_REQUEST.getCode());
    }
    ...
    public R<?> methodArgumentNotValidExceptionExceptionHandler(MethodArgumentNotValidException ex) {
        ...
        return R.error(String.format("请求参数不正确:%s", fieldError.getDefaultMessage()),BAD_REQUEST.getCode());
    }
    ...
    public R<?> noHandlerFoundExceptionHandler(HttpServletRequest req, NoHandlerFoundException ex) {
        ...
        return R.error( String.format("请求地址不存在:%s", ex.getRequestURL()),NOT_FOUND.getCode());
    }
    ...
    public R<?> httpRequestMethodNotSupportedExceptionHandler(HttpRequestMethodNotSupportedException ex) {
        ...
        return R.error(String.format("请求方法不正确:%s", ex.getMessage()),METHOD_NOT_ALLOWED.getCode());
    }
